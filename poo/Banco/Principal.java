...
public class Principal
{
    ...
    public static void realizarOperacoes(Banco b){
        //listas as contas e escolhe conta
        Conta c = escolhaConta( b.getContas() );
        //escolher a operacao
        System.out.println("### Escolha a operaca " +
        "(D)eposito ou (R)etirada?");
        //digite um valor
        //realizar a operacao
        if (leExt.next().equalsIgnoreCase("D")){
            System.out.println("### Informe o valor da operacao:");
    ...
    public static Conta escolhaConta(ArrayList<Conta> contas){
        ...
        int escolha = leExt.nextInt();leExt.nextInt();
